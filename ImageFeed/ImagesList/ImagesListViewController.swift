...
//  ImageFeed
//
//  Created by Александр Гегешидзе on 05.11.2023.
//
...
final class ImagesListViewController: UIViewController {
    ...
    private func configCell(for cell: ImagesListCell, with indexPath: IndexPath) {
        ...
        if indexPath.row % 2 == 0 {
            cell.likeButton.imageView?.image = UIImage(named: "likeButtonOn")
        } else {
            cell.likeButton.imageView?.image = UIImage(named: "likeButtonOff")
        }
    }
